				...
				<div class="col-lg-12">
					...
					<div class="featured__controls">
						<ul>
							...
							<li data-filter=".<%=cb.getCategoryId()%>"><a href="seecategory?categoryId=<%=cb.getCategoryId() %>" style="color: black"> <%=cb.getCategoryName()%>
							</a></li>
				...
				<div class="col-lg-12">
					<div class="footer__copyright">
						...
						<div class="footer__copyright__payment">
							<img src="assets/buyer/img/payment-item.png" alt="">
						</div>
					</div>
				</div>
			</div>
